 ...
 * ----------------------------------------------------------------------------
 */
package com.aronixcompany.veteninaria.Excepciones;

/**
 * ----------------------------------------------------------------------------
 * [ DESCRIPCIÓN TÉCNICA ]
 * ----------------------------------------------------------------------------
 * Descripción : Clase para el control de excepciones personizdas
 * Módulos : Exception
...
public class PropietarioNoEncontradoException extends Exception {
    ...
    /**
     * Error si no encuentra el propietario
     * @param mensaje mensaje a imprimir
     */
    public PropietarioNoEncontradoException(String mensaje) {
        super(mensaje);
    }
